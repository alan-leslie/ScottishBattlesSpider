...
//    this._zoomInDiv = this._timeline.getDocument().createElement("div");
////    this._zoomInDiv.id = "timeline-band-" + index; - tod name this properly
//    this._zoomInDiv.id = "ZoomIn";
//    this._zoomInDiv.className = "timeline-band timeline-band-ZoomIn" + index;
//    this._timeline.addDiv(this._zoomInDiv);
//    
//    var zoomInElmt = document.createElement("img");
//    zoomInElmt.id = "ZoomIn_icon";
//    //this._innerDiv.className = "timeline-band-inner";  // id e.g. zoomslider_icon not class
//    zoomInElmt.setAttribute("src", "file:///home/al/zoom-plus-mini.png");
// //   elmt.style.verticalAlign = (verticalAlign != null) ? verticalAlign : "middle";
//    this._zoomInDiv.appendChild(zoomInElmt);
//
////    this._zoomBarDiv = this._timeline.getDocument().createElement("div");
//////    this._zoomBarDiv.id = "timeline-band-" + index; - tod name this properly
////    this._zoomBarDiv.id = "Zoombar";
////    this._zoomBarDiv.className = "timeline-band timeline-band-Zoombar" + index;
////    this._timeline.addDiv(this._zoomBarDiv);
//
//   this._zoomSliderDiv = this._timeline.getDocument().createElement("div");
////    this._zoomSliderDiv.id = "timeline-band-" + index; - todo name this properly
//    this._zoomSliderDiv.id = "ZoomSlider";
//    this._zoomSliderDiv.className = "timeline-band timeline-band-ZoomSlider" + index;
//    this._timeline.addDiv(this._zoomSliderDiv);
//    
//    var zoomSliderElmt = document.createElement("img");
//    zoomSliderElmt.id = "ZoomSlider_icon";
//    //this._innerDiv.className = "timeline-band-inner";  // id e.g. zoomslider_icon not class
//    zoomSliderElmt.setAttribute("src", "file:///home/al/slider.png");
// //   elmt.style.verticalAlign = (verticalAlign != null) ? verticalAlign : "middle";
//    this._zoomSliderDiv.appendChild(zoomSliderElmt);
//    
//    this._zoomOutDiv = this._timeline.getDocument().createElement("div");
////    this._zoomOutDiv.id = "timeline-band-" + index; - tod name this properly
//    this._zoomOutDiv.id = "ZoomOut";
//    this._zoomOutDiv.className = "timeline-band timeline-band-ZoomOut" + index;
//    this._timeline.addDiv(this._zoomOutDiv);
//    
//    var zoomOutElmt = document.createElement("img");
//    zoomOutElmt.id = "ZoomOut_icon";
//    //this._innerDiv.className = "timeline-band-inner";  // id e.g. zoomslider_icon not class
//    zoomOutElmt.setAttribute("src", "file:///home/al/zoom-minus-mini.png");
// //   elmt.style.verticalAlign = (verticalAlign != null) ? verticalAlign : "middle";
//    this._zoomOutDiv.appendChild(zoomOutElmt);
    /*
